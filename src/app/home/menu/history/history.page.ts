        ...
        if(this.user.id != 1){
          this.readAPI('http://localhost:8080/api/incidents/byUser/').subscribe((data) =>{
              ...
              if(this.history.length==0){
                this.history = [{
                    description: "Les incidents que vous signalerez étant connecté seront répertoriés ici.",
                    title: "Les incidents que vous signalerez étant connecté seront répertoriés ici.",
                    etat: "none"
                }]
              }
           });
